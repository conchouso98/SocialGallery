  ...
  <div class="modal-dialog" role="document">
	...
	<div class="row m-5">
		<div class="col-3 bg-primary border border-dark rounded p-3">
			<form enctype="multipart/form-data" action="index.php" method="POST" onsubmit="return segundaValidacion()">
				<input type="file" name="archivo" id="archivo" accept="image/png, .jpeg, .jpg, image/gif"><br /><br />
				<input type="hidden" name="MAX_FILE_SIZE" value="3000" />
				<input type="text" name="titulo" id="titulo" placeholder="Introduce el titulo."><br /><br />
